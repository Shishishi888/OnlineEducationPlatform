...
public class CodeGenerator {
    ...
    public void run() {
        ...
        gc.setOutputDir("/Users/shiyang/Projects/learn/OnlineEducationPlatform/backend/OnlineEducationPlatform/service/service_ucenter" + "/src/main/java"); // 建议使用绝对路径
        ...
        strategy.setInclude("ucenter_member"); // 对应数据库表的名称
